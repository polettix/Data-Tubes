...
set the log level, see L<Log::Log4perl::Tiny>.
...
package name will be considered relative to C<Text::Tubes::Plugin>, so
the C<+> plus sign will be substitued with C<Text::Tubes::Plugin::>. For
example:
