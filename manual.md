...
There is much, much more in [to\_files][to-files] than simply writing to
standard output, e.g.:

- how to frame your rendered stuff in headers, separators and footers;
- how to divide your outputs into multiple files.

You're encouraged to look at the specific documentation or at the
[extensive article in the Wiki][to-files-wiki].

[to-files-wiki]: https://github.com/polettix/Data-Tubes/wiki/Writing-to_files

The other noteworthy tool that you can find for writing is
[dispatch\_to\_files][dispatch-to-files]. This comes useful when you not
only want to shape and partition your outputs like [to\_files][to-files]
allows you to do, but also when you want to decide a totally different
output channel depending on the nature of the record (e.g. you might
want to send errors to a log file, good records down the pipeline, and
records that you want to think about in some other sink).
...
You can discover more in [the specific article in the
wiki][writing-dtf].

[writing-dtf]: https://github.com/polettix/Data-Tubes/wiki/Writing-dispatch_to_files
